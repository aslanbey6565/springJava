...
public class HashSet01 {
    ...
    /*
        ...
        i)HashSet  (No repetation) and no any method about index
       ...
       *** If the speed is important use HashSet
           If the order is important use TreeSet
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        hSet.add(null);//[null, A, B, H, Y, Z, M]
        hSet.add(null);
