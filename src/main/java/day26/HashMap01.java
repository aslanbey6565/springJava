...
public class HashMap01 {
        ...
        /*
            1)HashMap is "not-thread safe" //It doesnt work multiple thread(TASK)
    ...
    public static void main(String[] args) {
        ...
        System.out.println(hMap); //Alex Alex, 99 // if you use different value vith same key it will update value
