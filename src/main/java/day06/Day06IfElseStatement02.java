...
public class Day06IfElseStatement02 {
        ...
        public static void main(String[] args) {
            ...
            // regex: Regular expressions: They are used to define a group of data
            ...
            if ((pwd.replaceAll("[A-Za-z0-9]", "")).length() == 0) {
                ...
                //Note: If you use else if, it will display only one message on the console
                // If you use if, it will display all errors...
